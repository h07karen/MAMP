...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.6.0/arm64-darwin21")
  ...
  CONFIG["configure_args"] = " '--with-arch=arm64' '--prefix=/Applications/MAMP/Library' '--with-openssl-dir=/Applications/MAMP/Library' 'CFLAGS=-arch arm64 -DUSE_FFI_CLOSURE_ALLOC=1' 'LDFLAGS=-arch arm64' 'CXXFLAGS=-arch arm64'"
  ...
  CONFIG["warnflags"] = "-Wall -Wextra -Wdeclaration-after-statement -Wdeprecated-declarations -Wdivision-by-zero -Wimplicit-function-declaration -Wimplicit-int -Wmisleading-indentation -Wpointer-arith -Wshorten-64-to-32 -Wwrite-strings -Wmissing-noreturn -Wno-constant-logical-operand -Wno-long-long -Wno-missing-field-initializers -Wno-overlength-strings -Wno-parentheses-equality -Wno-self-assign -Wno-tautological-compare -Wno-unused-parameter -Wno-unused-value -Wunused-variable -Wextra-tokens"
  ...
  CONFIG["DLDFLAGS"] = "-arch arm64 -Wl,-undefined,dynamic_lookup -Wl,-multiply_defined,suppress"
  CONFIG["ALLOCA"] = ""
  CONFIG["MATHN"] = "yes"
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "Apple clang version 13.0.0 (clang-1300.0.29.30)\nTarget: arm64-apple-darwin21.2.0\nThread model: posix\nInstalledDir: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin"
  ...
  CONFIG["build"] = "arm-apple-darwin21.2.0"
