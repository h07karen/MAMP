...
'MODPERL_CC' => 'cc',
'MODPERL_CCCDLFLAGS' => ' ',
'MODPERL_CCOPTS' => ' -fno-common -DPERL_DARWIN -mmacosx-version-min=11.0 -fno-strict-aliasing -pipe -fstack-protector-strong -DPERL_USE_SAFE_PUTENV -I/Applications/MAMP/Library/lib/perl5/5.30.1/darwin-thread-multi-2level/CORE -DMOD_PERL -DMP_COMPAT_1X -std=gnu89 -DDARWIN -DSIGPROCMASK_SETS_THREAD_MASK',
'MODPERL_CP' => 'cp',
'MODPERL_CPPRUN' => 'cc  -E',
...
'MODPERL_LD' => 'cc',
'MODPERL_LDDLFLAGS' => ' -mmacosx-version-min=11.0 -bundle -undefined dynamic_lookup -L/usr/local/lib -fstack-protector-strong',
'MODPERL_LDOPTS' => '   -mmacosx-version-min=11.0 -fstack-protector-strong -L/usr/local/lib  -L/Applications/MAMP/Library/lib/perl5/5.30.1/darwin-thread-multi-2level/CORE -lperl',
...
'httpd_version' => {
                     '/Applications/MAMP/Library/include' => '2.4.54'
                   }
       }, 'Apache2::Build' );
}
